...
public class AdminDao {
	...
	public static boolean validateAdminExist(String name) {
		boolean status = false;
		try {
			...
			PreparedStatement ps = con
					.prepareStatement("select * from tblAdmin where username=?");
			ps.setString(1, name);
	...
	public static void main(String[] args){
		Admin a=AdminDao.getAdminByNameAndPassword("Zika","admin");
